...
# 数据集路径
dataset_dir = r'D:\学校\华清远见专题项目\华清远见大三\day3\dataset\Images'  # 替换为你的数据集路径
train_dir = r'D:\学校\华清远见专题项目\华清远见大三\day3\dataset\Images2\train'  # 训练集输出路径
val_dir = r'D:\学校\华清远见专题项目\华清远见大三\day3\dataset\Images2\val'  # 验证集输出路径
